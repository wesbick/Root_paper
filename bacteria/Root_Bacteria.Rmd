...
an_shannon <- aov(npshannon ~ Lineage * Site, data = meta_alpha)
summary(an_shannon)
...
par(oma = c(1, 1, 1, 1))
par(mar = c( 2, 3, 0.5, 9 ))
plot.window(xlim = c(-0.3,0.3), ylim = c(-0.3,0.3))
axis(side = 1)
axis(side = 2, las = 1)
...
plot(x=pcoa$axis1, y=pcoa$axis2, xlab="PCo Axis 1", ylab="PCo Axis 2",
            xlim=c(-0.40, 0.4), ylim=c(-0.4, 0.4), pch=21, col="black", bg=site_color[as.character(meta_alpha$Site)], lwd=1, cex=(pcoa$axis3+1),
            main="PCoA of BrayCurtis Distances Between Root Samples")

plot(x=pcoa$axis1, y=pcoa$axis3, xlab="PCo Axis 1", ylab="PCo Axis 3",
            xlim=c(-0.40, 0.4), ylim=c(-0.4, 0.4), pch=21, col="black", bg=site_color[as.character(meta_alpha$Site)], lwd=1, cex=(pcoa$axis2+1),
            main="PCoA of BrayCurtis Distances Between Root Samples")
```
###Remove rare taxa
...
plot(pcoa_ab, xlab="PCo Axis 1", ylab="PCo Axis 2",
            xlim=c(-0.40, 0.4), ylim=c(-0.4, 0.4), pch=21, col="black", bg=site_color[as.character(meta_alpha$Site)], lwd=1, cex=(pcoa$axis3+1),
            main="PCoA of BrayCurtis Distances Between Root Samples")
