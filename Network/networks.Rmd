...
bac_otus <- read.table(file = "~/git_repos/Root_bacterial/data/Bickford.subsample.shared", header = T)
...
# Fungi
fun_otus <- read.table(file = "~/git_repos/Root_ITS/data/Bickford.subsample.shared", header = T)
...
btaxonomy <- tax_table("data/Bickford.cons.taxonomy", "SILVA")
btaxonomy$otu <- paste("B_", btaxonomy$otu)
rownames(btaxonomy) <- btaxonomy$otu

ftaxonomy <- tax_table("~git_repos/Root_ITS/data/Bickford.cons.taxonomy", "UNITE")
